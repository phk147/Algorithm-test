...
function solution() {
  ...
  while (t--) {
    ...
    switch (cmd) {
      case "R":
        ...
        if (king[1] + 1 === stone[1] && stone[1] + 1 > 8) stone[1]++;
        king[1]++;
        break;
      case "L":
      ...
      case "B":
        ...
        if (king[0] - 1 === stone[0] && stone[0] - 1 >= 1) stone[0]--;
        king[0]--;
        break;
      case "T":
        if (king[0] + 1 > 8) continue;
        if (king[0] + 1 === stone[0] && stone[0] + 1 > 8) stone[0]++;
        king[0]++;
        break;
      case "RT":
  ...
  let ansKing = [alpabet[king[1]], king[0]];
  let ansStone = [alpabet[stone[1]], stone[0]];
